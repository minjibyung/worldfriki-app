...
<section className="Aside">
    <aside className="Aside1" category="accion">
        <h5>Avengers: Era de ultròn</h5>
        <a href="https://www.youtube.com/watch?v=DMFBm_lp4rU" target="_blank "><img src="https://res.cloudinary.com/dhypxlezc/image/upload/v1687637207/WorldFriki/peliculas/avengers_sir7ux.jpg"/></a>
{/* <!-- <h5>Sipnosis</h5>           
...
<aside className="Aside1" category="suspenso">
        <h5>Joker</h5>
        <a href="https://www.youtube.com/watch?v=EIyZqNbZQI8" target="_blank "><img src="https://res.cloudinary.com/dhypxlezc/image/upload/v1687648132/WorldFriki/peliculas/joker_hpley4.jpg"/></a>
{/* <!-- <h5>Sipnosis</h5>
...
<li>Cantidad de temporadas: 5</li>  --> */}
    ...
    <aside className="Aside1" category="accion">
    <h5>Top Gun: Pasion y Gloria</h5>
    <a href="https://www.panamericana.com.co/misery-3/p" target="_blank "><img src="https://res.cloudinary.com/dhypxlezc/image/upload/v1687648134/WorldFriki/peliculas/topgun_muzg2s.jpg"/></a> 
...
<aside className="Aside1" category="accion">
    ...
    <a href="https://www.panamericana.com.co/cementerio-de-animales/p" target="_blank "><img src="https://res.cloudinary.com/dhypxlezc/image/upload/v1687648134/WorldFriki/peliculas/maverick_ihfoak.jpg"/></a> 
...
<aside className="Aside1" category="romance">
    <h5>After: Amor infinito</h5>
    <a href="https://www.amazon.com/-/es/Stephen-King/dp/8466357238" target="_blank "><img src="https://res.cloudinary.com/dhypxlezc/image/upload/v1687648132/WorldFriki/peliculas/after_t51sm9.jpg"/></a> 
...
<aside className="Aside1" category="accion">
    ...
    <a href="https://www.casadellibro.com/libro-el-visitante/9788401021190/7099713" target="_blank "><img src="https://res.cloudinary.com/dhypxlezc/image/upload/v1687648135/WorldFriki/peliculas/thor_q8fnj8.jpg"/></a> 
...
<aside className="Aside1" category="suspenso">
    <h5>Zombie Apocalypse</h5>
    <a href="https://www.panamericana.com.co/doctor-sueno-588241/p" target="_blank "><img src="https://res.cloudinary.com/dhypxlezc/image/upload/v1687648136/WorldFriki/peliculas/zombie_hhmlow.png"/></a> 
...
<aside className="Aside1" category="suspenso">
    <h5>Fall</h5>
    <a href="https://www.panamericana.com.co/el-instituto-585646/p" target="_blank "><img src="https://res.cloudinary.com/dhypxlezc/image/upload/v1687637207/WorldFriki/peliculas/fall_w2c3ph.jpg"/></a> 
